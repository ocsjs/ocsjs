//绘制界面
var newmaindiv=$("<div id='newmaindiv'  style='background: antiquewhite;  width:400px;height:auto;right: 10%; position: fixed; z-index:9999;   top: 15%;border: 1px solid;'></div>");
...
$('#newmaindiv').append(topdiv);
$('#newmaindiv').append("<p>输入问题:</p><textarea id='myquestion' style='height:100px;'></textarea><p><button style='width:100px' onclick='query()'>  查询  </button><span id='zzcx'></span></p>");
$('#newmaindiv').append("<p id='myquestion2'>题目：</p><hr/><p style='height:50px' id='myanswer'>答案：</p>");
...
dragPanelMove("#topdiv","#newmaindiv");
