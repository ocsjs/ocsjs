						...
						{currentResult.value ? (
							...
							>
								<div class="search-result-header">
									...
									<span
										innerHTML={currentTitle.value.replace(
										...
										<div class="search-results-container">
											<span class="search-results-title">
												...
												<span>
													{' '}
													{res.error
														? '此题库请求错误: ' + res.error.message
														: `一共有 ${res.answers.length} 个结果`}{' '}
												</span>
											</span>
											{res.error ? (
												<div></div>
														...
														<div class="search-results-item">
															<div title={answer.question}>
																<span>
																	...
																	<div
																		innerHTML={answer.question?.replace(
																			/https?:\/\/.*?\.(png|jpg|jpeg|gif)/g,
																			(match) => `<img src="${match}" />`
																		)}
																	></div>
															...
															<div title={answer.answer}>
																<span>
																	...
																	{/* 判断是否有网络图片格式的文本，有则替换成 img 标签 */}
																	<div
																		innerHTML={answer.answer?.replace(
																			/https?:\/\/.*?\.(png|jpg|jpeg|gif)/g,
																			(match) => `<img src="${match}" />`
																		)}
																	></div>
							...
							{local.workResults.map((res, i) => {
								...
								return (
									...
									>
										...
										>
											<Tooltip title="复制题目">{isCopy.value ? '✅' : '📄'}</Tooltip>
										</span>
