...
function compareVersions(v1, v2) {
    var _a, _b;
    var v1_nums = (_a = v1.match(/\d/g)) === null || _a === void 0 ? void 0 : _a.map(function (v) { return parseInt(v); });
    var v2_nums = (_b = v2.match(/\d/g)) === null || _b === void 0 ? void 0 : _b.map(function (v) { return parseInt(v); });
    if (v1_nums && v2_nums) {
        for (var i = 0; i < v1_nums.length; i++) {
