...
- 2.解压缩browser.7z
下载后是这样的：
![压缩包图片](https://ghcdn.rawgit.org/KL-Skeleton/OnlineCourseScript/blob/master/src/ysb.png)
- 3.打开专用浏览器
![专用浏览器](https://ghcdn.rawgit.org/KL-Skeleton/OnlineCourseScript/blob/master/src/index.png)
- 4.登录，并进入到超星或者智慧树，的学习界面
![学习界面](https://ghcdn.rawgit.org/KL-Skeleton/OnlineCourseScript/blob/master/src/studypage.png)
